...
\begin{equation}
        X[k] = \sum_{n = 1}^N x[n] e^{-2\pi j (k - 1)(n - 1)/N}, k \in \{1, \ldots, N\}
\end{equation}
...
\begin{figure}
  ...
  \caption[Magnitude spectrum of the acoustic guitar recording]{Magnitude spectrogram of the audio recording of an acoustic guitar shown in \cref{fig:audio_signal}.
...
% Typically, the temporal spacing between subsequent elements in a signal is fixed and is determined by the signal's sampling frequency $f_s$.

\subsubsection{The Short-Time Fourier Transform}

\subsubsection{Window Functions}

\subsubsection{The Constant-Q Transform}

\subsubsection{Chroma Vectors}
