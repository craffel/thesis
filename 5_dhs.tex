...
From top left to bottom right: synthesized MIDI CQT-to-audio recording CQT, the TPAA method described in \cref{sec:baseline}, MIDI piano roll-to-audio CQT, downsampled hash vectors using this ``multimodal'' data as described in \cref{sec:multimodal}, CQT-to-CQT hashing network output prior to thresholding, and downsampled hash vectors using the method in \ref{sec:hashing_system}.}
