...
Compared to the approximately 1.5 days it would take to match a single MIDI file to the MSD using the DTW approach from \cref{sec:goldstandard} on its own, we consider the 5.4\% false reject rate a small price to pay for this increase in efficiency.
