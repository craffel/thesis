...
This is motivated by our collection of 178,561 unique MIDI transcriptions which, as we will explore in \cref{ch:extracting}, can provide a bounty of ground-truth data for content-based music information retrieval tasks.
