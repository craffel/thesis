...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/3-original_cqt.pdf}
  \includegraphics[width=\textwidth]{figures/3-corrupted_cqt.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/3-warping.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/3-correction_error.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/3-correlation.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/3-violin.pdf}
...
Nevertheless, there was some overlap between the distribution of confidence scores for each rating.
This implies that our system cannot detect fine-grained issues such as missing instruments or other minor alignment issues.
...
Our proposed framework for creating alignment datasets and optimizing system design using Bayesian optimization could be straightforwardly extended to accomodate these new directions.

Given the success of our system at discriminating between correct and incorrect matches, it would appear that it is a viable method matching MIDI transcriptions to corresponding audio recordings in a database.
