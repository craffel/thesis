...
Given our extremely large collection of MIDI files and the possibility of leveraging the sources of information available of them outlined in \cref{sec:information}, the remainder of this thesis focuses on matching and aligning this collection to the Million Song Dataset \cite{bertin2011million}.
